...
namespace Valve.VR.InteractionSystem
{
    ...
    public class SnapTurn : MonoBehaviour
    {
		...
		public bool allowSnapTurnWhileHoldingObject;
        ...
        private void Update()
        {
            ...
            if (canRotate && snapLeftAction != null && snapRightAction != null && snapLeftAction.activeBinding && snapRightAction.activeBinding)
            {
                ...
                bool rightHandValid = allowSnapTurnWhileHoldingObject || player.rightHand.currentAttachedObject == null ||
                ...
                bool leftHandValid = allowSnapTurnWhileHoldingObject || player.leftHand.currentAttachedObject == null ||
